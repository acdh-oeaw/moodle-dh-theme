...
/**
 * Strings for component 'theme_dariahteach', language 'en'
 *
...
$string['choosereadme'] = 'Readme';
$string['configtitle'] = 'dariahteach';
$string['connectus'] = 'Connect with us';
$string['contact'] = 'Contact';
$string['customcss'] = 'Custom CSS';
$string['customcssdesc'] = 'Add Custom css';
...
$string['region-side-content'] = 'FP: LEFT, ';
$string['region-center-post'] = 'FP: RIGHT, COURSE: LEFT MENU';
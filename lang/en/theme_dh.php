...
/**
 * Strings for component 'theme_dh', language 'en'
 *
 * @package   theme_dh
 * @copyright 2019 ACDH
...
$string['region-fp-tag'] = 'Front-page Tag';


$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot"><img class=img-polaroid src="dh/pix/screenshot.jpg" /><br/><p></p><h3>Theme Credits</h3><p><h3>Moodle dh theme</h3><p>This theme is based on the Boost Moodle theme.</p><p>Authors: LMSACE Dev Team<br>Contact: info@lmsace.com<br>Website: <a href="http://www.lmsace.com">www.lmsace.com</a><br></p>';

$string['configtitle'] = 'dh';
...
$string['pluginname'] = 'dh';
$string['readmore'] = 'Read More';
$string['more-info'] = 'More Information';

    ...
    <script type="text/javascript">
         ...
         $(document).on('click','#StepButton input:submit',function() {
           ...
           $("#StepButton").submit(function(ev){
               ...
               var courseID = $(this).find('input[name="id"]').val();
               ...
               $.ajax({
                    ...
                    success: function (data) {
                        if(data.nextstepid == "-9"){
                            window.location.replace("view.php?id="+courseID+"&pageid=-9");
                        }else if(data.nextstepid == "0"){
                            window.location.replace("view.php?id="+courseID+"&pageid="+data.prevstepid);
                            $('#lesson-'+ data.prevstepid +' tbody').show();
                            $('#lesson-'+ data.prevstepid +' thead th.header').css("background-color", "#016771");
                            $('#lesson-'+ data.prevstepid +' thead th.header').css("color", "white");

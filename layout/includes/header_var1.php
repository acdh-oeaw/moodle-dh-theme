...
$isStudent = false;
$userRoles = get_user_roles(context_course::instance(36), $USER->id, false);
foreach($userRoles as $role) {
    if($role->shortname == 'student'){
        echo '<input type="hidden" id="student-rights" value="student">';
    }else {
        echo '<input type="hidden" id="student-rights" value="teacher">';
    }
}
...
$logo_text = $CFG->wwwroot.'/theme/lambda/pix/logo_title_450.png';
?>
    ...
    <div class="row-fluid">
        ...
        <div class="span4" style="margin-left: 20px;">
            <div class="header_text_logo">
               <img src="<?php echo $logo_text; ?>" class="img-responsive">
            </div>
        </div>
        <?php } ?>      	

        <div class="span7 login-header">
